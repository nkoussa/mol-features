...
datadir  = Path('/vol/ml/apartin/projects/covid-19/ML-docking-dataframe-generator/data/processed/descriptors/ena_db')
outdir = datadir
...
def run(args):
    ...
    # Save
    print_fn('\nSave ...')
    smi_dsc.to_parquet(outdir/'smi.desc.parquet')
