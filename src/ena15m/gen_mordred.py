...
datadir = Path('/vol/ml/apartin/projects/covid-19/ML-docking-dataframe-generator/data/raw/raw_data/V3_docking_data_april_16/docking_data_out_v3.2.csv')
## outdir = datadir
outdir = Path('/vol/ml/apartin/projects/covid-19/ML-docking-dataframe-generator/data/processed/features/ena15m')

# SMILES_PATH = str( datadir/'ena+db.smi.can.csv' )
SMILES_PATH = str( datadir )
...
def run(args):
    ...
    dsc = smiles_to_mordred(smi, smi_name='smiles', n_jobs=64)
    ...
    data.to_parquet( outdir/'ena15m.dsc.parquet' )
